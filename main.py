...
SUDO = int(os.environ.get("SUDO","1959172275"))
...
def start(message):
	...
	if f == SUDO:
		...
		me = types.InlineKeyboardButton(text="دراكون",url="https://t.me/T2R_9")
		he = types.InlineKeyboardButton(text="مصنع بوتاتي",url="https://t.me/T2R_9BOT")
		de = types.InlineKeyboardButton(text="مجر دراكون",url="https://t.me/T2R_8bot")
		ch = types.InlineKeyboardButton(text="▶ قناة البوت ◀",url="https://t.me/Dragon_2022_D")
		rr.add(me,he,de)
		rr.add(ch)
